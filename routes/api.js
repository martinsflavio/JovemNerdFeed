...
router.post('/:resource/:method', (req, res, next) => {
  ...
  if (method === 'create') {
    ...
    return res.status(500).json({message: 'fail', err: `${method} => Invalid Method for POST Request!`});
  }
});
///////////////////////////////////////////////////
...
router.put('/:resource/:method', (req, res, next) => {
  ...
  if (method === 'update') {
    ...
    return res.status(500).json({message: 'fail', err: `${method} => Invalid Method for PUT Request!`});
  }
});
///////////////////////////////////////////////////
...
router.delete('/:resource/:method', (req, res, next) => {
  ...
  if (method === 'destroy') {
    ...
    return res.status(500).json({message: 'fail', err: `${method} => Invalid Method for DELETE Request!`});
  }
});
///////////////////////////////////////////////////
